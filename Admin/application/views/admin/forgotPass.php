                ...
                <div id="main-wrapper">
                    <div class="row">
                        <div class="col-md-3 center">
                            <div class="login-box">
                                <a href="index-2.html" class="logo-name text-lg text-center">Forgot Password</a>
                                ...
                                <form class="m-t-md">
                                    ...
                                    <a href="<?php echo base_url()?>apanel/index" class="btn btn-default btn-block m-t-md">Back</a>
                                </form>
                                <p class="text-center m-t-xs text-sm">2018 &copy; Niktech Software Solution.</p>
                            </div>
                        </div>
                    </div><!-- Row -->
                </div><!-- Main Wrapper -->
