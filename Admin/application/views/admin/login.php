                ...
                <div id="main-wrapper">
                    <div class="row">
                        <div class="col-md-3 center">
                            <div class="login-box">
                                <a href="<?php echo base_url()?>apanel/index" class="logo-name text-lg text-center">DDS Manner Higher Secondary School Admin Panel</a>
                                ...
                                <p class="text-center m-t-xs text-sm">2018 &copy; Niktech Software Solutions.</p>
                            </div>
                        </div>
                    </div><!-- Row -->
                </div><!-- Main Wrapper -->
