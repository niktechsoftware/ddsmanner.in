...
<head>
        ...
        <!-- Title -->
        <title>DDS Manner Higher Secondary School</title>
                ...
                <div id="main-wrapper">
                    <div class="row">
                        <div class="col-md-3 center">
                            <div class="login-box">
                                <a href="<?php echo base_url()?>apanel/index" class="logo-name text-lg text-center">DDS Manner Higher Secondary School</a>
