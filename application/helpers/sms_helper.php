...
{  $url="http://bulksms.gfinch.in/api/sendmsg.php?user=ddsmannermau&pass=mau@123&sender=DDSMNR&phone=".$number."&text=".urlencode($msg)."&priority=ndnd&stype=normal";
...
{ 
$url = "http://bulksms.gfinch.in/api/checkbalance.php?user=ddsmannermau&pass=mau@123";
$ch = curl_init();
curl_setopt($ch,CURLOPT_URL,$url);
curl_setopt($ch,CURLOPT_RETURNTRANSFER,true);
$output=curl_exec($ch);
