	...
	<div class="container">
    	<div class="row">
            ...
            <div class="span6 trial">
            	...
            	<p><span style="color:#fff;"><a href='<?php echo base_url();?>index.php/welcome/index'>Home</a> / <a href='#'>About Us</a> / <a href='<?php echo base_url();?>index.php/welcome/infrastructure'>Infrastructure</a>  </span></p>
            </div>
        </div>
    </div>
</div>
...
<div class="main-content" style="background: #fff;min-height:400px;">
    <div class="container" style="margin-top:40px;margin-bottom:40px;">
        <div class="row">
			<!-- Page Content start //-->
			<div class="span12">			
				 <p><img src="#" alt="" /></p><h2>Comming Soon</h2></div>
        </div>
    </div>    
</div>
<!--main content end //-->
