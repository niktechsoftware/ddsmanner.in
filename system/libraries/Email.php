...
class CI_Email {
	...
	var	$smtp_host		= "webmail.ddsmanner.in";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "info@ddsmanner.in";		// SMTP Username
	var	$smtp_pass		= "Kanpur!@12";		// SMTP Password
